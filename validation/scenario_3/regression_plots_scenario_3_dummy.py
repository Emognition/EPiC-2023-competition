...
dummy_regressor_arousal = DummyRegressor(strategy='mean')	
dummy_regressor_valence = DummyRegressor(strategy='mean')

# Loop over scenarios
for fold in range(5):
    # Get all files in the directory
    files = os.listdir(f"../../data/test_set/scenario_3/fold_{fold}/test/annotations/")
    ...
    train_files = glob(f"../../data/raw/scenario_3/fold_{fold}/train/annotations/*.csv")
    ...
    for file in files:
        ...
        # Load the data
        df_test = pd.read_csv(f"../../data/test_set/scenario_3/fold_{fold}/test/annotations/{file}")
        df_pred = pd.read_csv(f"../../results/scenario_3/fold_{fold}/test/annotations/{file}")
