...
class EpicData2(BaseData):
    ...
    def __init__(self, root_dir=None, file_list=None, pattern=None, n_proc=1, limit_size=None, config=None):
        ...
        df = pd.read_csv('./train_scenario_2_all_fold.csv',dtype='float32')
...
class EpicData1(BaseData):
    ...
    def __init__(self, root_dir=None, file_list=None, pattern=None, n_proc=1, limit_size=None, config=None):
        ...
        df = pd.read_csv('./train_scenario_1_all_fold.csv',dtype='float32')
        # grouped = df.groupby(['ID','VIDEO_FILENAME'],as_index=False, group_keys=False)
        # size = grouped.size()
        self.all_df = df
...
data_factory = {'weld': WeldData,
                ...
                'pmu': PMUData,
                'epic1': EpicData1, 'epic2': EpicData2, 'epictest': EpicDataTest}
